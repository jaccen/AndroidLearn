...
//
//#include "Explosion.h"
//Explosion::Explosion(int numParticles, vec3 origin, float spread, GLuint texture)
//        : m_texture(texture), m_spread(spread), Particle(numParticles, origin)
//{
//    srand(timeGetTime());
...
//}
//
//void Explosion::InitializeParticle(int index)//爆炸初始化
//{
...
//}
//void Explosion::Update(float elapsedTime)//清除爆炸动画
//{
